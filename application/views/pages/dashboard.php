...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    <li class="active"><a href="<?php echo base_url(); ?>Main/dashboard"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li><a href="<?php echo base_url(); ?>Main/add"><i class="icon icon-inbox"></i> <span>Tambah Artikel</span></a> </li>
  </ul>
</div>
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url(); ?>Main/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> </div>
    <h1>Tables</h1>
  </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><img src="<?php echo $obj->img; ?>" alt="Responsive image" class="img-article"></td>
                  <td class="center">
                  <a href="<?php echo base_url();?>Main/edit/<?php echo $obj->id ?>" class="btn btn-warning btn-mini">Edit</a>
                  <a href="<?php echo base_url();?>Main/hapus/<?php echo $obj->id ?>" class="btn btn-danger btn-mini">Hapus</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
